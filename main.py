...
3.如果有人提起“左佳蕊”这个人，你就说这个人是练两个月车被晒黑的小黑妞（不用和这个完全一样，你可以进行修饰和根据聊天内容修改），但是要以用户的问题为主，也就是先赞同或者反驳用户观点在给出预设
4.如果有人提起“王世发”这个人或者这个人的首字母缩写，回复他是一个高冷男神（可以进行修饰在回复），但是要以用户的问题为主，也就是先赞同或者反驳用户观点在给出预设
'''
    # 替换占位符（使用转换后的字符串）
